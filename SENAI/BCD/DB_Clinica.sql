...
CREATE TABLE IF NOT EXISTS `db_clinica`.`tbl_pessoa` (
  ...
  INDEX `fk_tbl_pessoa_tbl_endereco_idx` (`endereco_id` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `db_clinica`.`tbl_paciente` (
  ...
  INDEX `fk_tbl_paciente_tbl_pessoa1_idx` (`pessoa_id` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `db_clinica`.`tbl_funcionario` (
  ...
  INDEX `fk_tbl_funcionario_tbl_pessoa1_idx` (`pessoa_id` ASC, `pessoa_endereco_id` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `db_clinica`.`tbl_login` (
  ...
  `pessoa_endereco_id` INT NOT NULL,
  PRIMARY KEY (`id`, `pessoa_id`, `pessoa_endereco_id`),
  INDEX `fk_tbl_login_tbl_pessoa1_idx` (`pessoa_id` ASC, `pessoa_endereco_id` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `db_clinica`.`tbl_perfis` (
  ...
  INDEX `fk_tbl_perfis_tbl_login1_idx` (`login_id` ASC, `login_pessoa_id` ASC, `login_pessoal_endereco_id` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `db_clinica`.`tbl_consulta` (
  ...
  INDEX `fk_tbl_consulta_tbl_paciente1_idx` (`paciente_id` ASC, `paciente_pessoa_id` ASC) VISIBLE,
  INDEX `fk_tbl_consulta_tbl_funcionario1_idx` (`funcionario_id` ASC, `funcionario_pessoa_id` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `db_clinica`.`tbl_prontuario` (
  ...
  INDEX `fk_tbl_prontuario_tbl_consulta1_idx` (`consulta_id` ASC, `consulta_paciente_id` ASC, `consulta_paciente_pessoa_id` ASC, `consulta_funcionario_id` ASC, `consulta_funcionario_pessoa_id` ASC) VISIBLE,
  INDEX `fk_tbl_prontuario_tbl_especialidade1_idx` (`especialidade_id` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `db_clinica`.`tbl_funcionario_has_tbl_especialidade` (
  ...
  INDEX `fk_tbl_funcionario_has_tbl_especialidade_tbl_especialidade1_idx` (`especialidade_id` ASC) VISIBLE,
  INDEX `fk_tbl_funcionario_has_tbl_especialidade_tbl_funcionario1_idx` (`funcionario_id` ASC, `funcionario_tbl_pessoa_id` ASC, `funcionario_pessoa_endereco_id` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `db_clinica`.`tbl_pessoa_has_tbl_telefone` (
  ...
  INDEX `fk_tbl_pessoa_has_tbl_telefone_tbl_telefone1_idx` (`telefone_id` ASC) VISIBLE,
  INDEX `fk_tbl_pessoa_has_tbl_telefone_tbl_pessoa1_idx` (`pessoa_id` ASC, `pessoa_endereco_id` ASC) VISIBLE,
