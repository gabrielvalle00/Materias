    ...
    let listViewItem = (item) => {
        return (
            <View style={styles.modeloCard}>
                ...
                <Text style={styles.textValue}>{item.telefone_celular}</Text>

                <Text style={styles.textHeader}>Telefone fixo</Text>
                <Text style={styles.textValue}>{item.telefone_fixo}</Text>
                ...
                <View style={styles.containerButto}>
                    ...
                    <TouchableOpacity onPress={() => {
                        navegaEditar(item.id, item.nome, item.telefone_celular, item.telefone_fixo, item.email)
                    }}>
